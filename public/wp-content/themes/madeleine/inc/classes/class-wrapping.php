...
add_filter( 'madeleine_wrap_base', 'madeleine_wrap_base_cpts' );
 ...
 */
function madeleine_template_path() {
 ...
 */
function madeleine_template_base() {
...
if ( ! class_exists( '__Tm_Wrapping' ) ) {
	...
	class __Tm_Wrapping {
		...
		public function __toString() {
			$this->templates = apply_filters( 'madeleine_wrap_' . $this->slug, $this->templates );
 ...
 */
function madeleine_wrap_base_cpts( $templates ) {
